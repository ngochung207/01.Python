...
# for key1 in dicA.keys():
#     # Quét toàn bộ các phần tử trong dicB, nạp vào temp các phần tử của dicB mà nhỏ hơn dicA.get(key1)
#     for key2 in dicB.keys():
...
#     else:
#         for key3 in temp.keys():
#             if dicA.get(key1) - temp.get(key3) >= -2000000 and dicA.get(key1) - temp.get(key3) <= 20000000:
#                 ketQua[i, 0] = key1
#                 ketQua[i, 1] = key1
#                 ketQua[i, 2] = key3
#                 ketQua[i, 3] = dicA.get(key1)
...
# dicA1 = sorted(dicA.items(), key=lambda t: t[1])
# dicB1 = sorted(dicB.items(), key=lambda t: t[1])
ls = list()
# ---------------------------------------------------------------------------------------------------------------
